...
async function onload()
{
    ...
    document.getElementById('watchHeading').innerHTML = "<div style='text-align:center;'> You have all the slots available for <span class='pop'>" + districtsSelect.options[districtsSelect.selectedIndex].text + "</span> district.</div>"
...
function main(data, renderFilter)
{
    ...
    if (!data || data.length === 0)
    {
        ...
        if (!watching) document.getElementById('watchHeading').innerHTML = "<div style='text-align:center;'> You have all the slots available for <span class='pop'>" + currentDistrict + "</span> district.</div>"
        document.title = "CovidVaccine | " + currentDistrict
